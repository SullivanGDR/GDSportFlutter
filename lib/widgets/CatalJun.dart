...
class CatalJun extends StatefulWidget {
  const CatalJun({super.key});

  @override
  State<CatalJun> createState() => _CatalJunState();
}

class _CatalJunState extends State<CatalJun> {
  List<Article> _articles = [];
  List<Article> _filteredArticles = [];
  Set<String> _genres = {'Tous', 'Junior'};
  Set<String> _types = {'Tous'};
  String _selectedGenre = 'Junior'; // Définit sur 'Junior'
  ...
  void chargement() async {
    ...
    filterArticles(); // Applique le filtre "Junior" dès le chargement
