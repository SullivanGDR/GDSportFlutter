...
class CatalHom extends StatefulWidget {
  const CatalHom({super.key});

  @override
  State<CatalHom> createState() => _CatalHomState();
}

class _CatalHomState extends State<CatalHom> {
  List<Article> _articles = [];
  List<Article> _filteredArticles = [];
  Set<String> _genres = {'Tous', 'Homme'};
  Set<String> _types = {'Tous'};
  String _selectedGenre = 'Homme'; // Définit sur 'Homme'
  ...
  void chargement() async {
    ...
    filterArticles(); // Applique le filtre "Homme" dès le chargement
